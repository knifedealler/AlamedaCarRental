...
public class DU_Panel extends javax.swing.JPanel{
    ...
    public DU_Panel(CarsArray carsArray) {
        ...
        carsArray.addCarsArray(new Cars("Accord","1121","123456789","Shumen","Honda","12-20-2011",true,1,4,"12-13-2019"));
        carsArray.addCarsArray(new Cars("RAV4","11","123987654","Varna","Toyota","19-20-2016",true,2,4,"11-12-2025"));
        carsArray.addCarsArray(new Cars("A8","1231","128837789","Burgas","BMW","12-20-2007",false,1,3,"09-12-2015"));
        carsArray.addCarsArray(new Cars("City","2221","122324289","Sofia","Honda","12-20-2013",false,2,5,"01-21-2016"));
        carsArray.addCarsArray(new Cars("Silverado","13431","123455489","Varna","Chevrolet","12-20-2011",true,1,4,"12-12-2017"));
        carsArray.addCarsArray(new Cars("Cherokee","19981","12212489","Varna","Jeep","12-20-2011",false,1,7,"03-12-2019"));
        carsArray.addCarsArray(new Cars("Sonata","134531","122325489","Shumen","Hundai","12-20-2003",true,1,4,"13-12-2020"));
        carsArray.addCarsArray(new Cars("Sentra","134991","1887639","Burgas","Nissan","12-20-2009",true,1,4,"13-12-2017"));
        carsArray.addCarsArray(new Cars("Sierra","93491","99865669","Sofia","GMC","12-20-2011",false,1,2,"13-12-2018"));
        carsArray.addCarsArray(new Cars("Mazda6","65344","9897489","Sofia","Mazda","12-20-2017",true,1,4,"13-12-2025"));
...
//        }
        ...
        choose[1]="Налични автомобили";
        choose[2]="Заети автомобили";
        choose[3]="Марка:____";
        choose[4]="Произведен в година ____";
        choose[5]="Намери кола по пасажерски места";
        choose[6]="Намери кола по сериен номер";
        choose[7]="Кола модел:____";
        choose[8]="От коя година е почнат да се наема";
        choose[9]="Коли в град: ____";
        choose[10]="Коли с изтекъл преглед";
    ...
    private void displayUpdate()
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Избери ред за показване");
        }  
    ...
    private void updateAction(Cars cars)
    {
        ...
        integerCheck(modelNum, "Номер на модела");
        stringCheck(mod,"Модел");
        stringCheck(manuf, "Производител");
        dateCheck(manufYr,"Дата на производство");
        stringCheck(cIty, "Град");
        dateCheck(certExp, "Изтичане на преглед");
        integerCheck(serNO, "Сериен номер");
        integerCheck(maxiSeat, "Места за сядане максимум");
        integerCheck(miniSeat,"Места за сядане минимум");
        
        if(Integer.parseInt(miniSeat)>Integer.parseInt(maxiSeat))
        {
            error=1;
            JOptionPane.showMessageDialog(null, "Максималните места за сядане трябва да са повече от минималния", "Error", 0);
        }
        ...
        if(error!=1)
        {
            ...
            JOptionPane.showMessageDialog(null, "Запазено успешно");
    ...
    private void integerCheck(String checkThis, String field)
    {
        ...
        {
            error=1;
            JOptionPane.showMessageDialog(null, field+" Формата трябва да е в цифри","ERR0R",0);       
        }
    }
    ...
    private void stringCheck(String checkThis, String field)
    {
        try
        {
            ...
            {
                error=1;
                JOptionPane.showMessageDialog(null,"Моля въведи "+field +" в подходящ формат", "Error", 0);
            }
        }
        catch(Exception e){}
    ...
    private void dateCheck(String checkThis, String field)
    {
         try
        {
            ...
            {
                error=1;
                JOptionPane.showMessageDialog(null,"Моля въведи "+field +" датата в подходящ формат", "Error", 0);
            }
        }
        catch(Exception e)
        {
                ...
                {
                    error=1;
                    JOptionPane.showMessageDialog(null,"Моля въведи "+field+"датата в подходящ формат ММ-ДД--ГГГГ","ERROR",0);
                }    
...
//        dtm.setRowCount(0);
        ...
        carsArray=carAr;
        displayTable(carsArray);
        statusLabel.setText("Налични автомобили: "+count);
    }
...
//System.out.println("in unavailable");
        ...
        displayTable(carsArray);
        statusLabel.setText("Заети автомобили: "+count);
...
//        dtm.setRowCount(0);
        ...
        if(counter==0)
        {   
            JOptionPane.showMessageDialog(null, "Няма коли от този производител "+company);
        }
        else
        {
            carsArray=carAr;
...
//        dtm.setRowCount(0);
        ...
        if(counter==0)
        {   
            JOptionPane.showMessageDialog(null, "Няма коли произведени в тази година: "+year);
        }
        else
        {
            carsArray=carAr;
...
//        dtm.setRowCount(0);
        ...
        if(counter==0)
        {   
            JOptionPane.showMessageDialog(null, "Няма коли с тези критерии");
        }
        else
        {
            carsArray=carAr;
...
//                dtm.addRow(ob);
        ...
        if(counter==0)
        {   
            JOptionPane.showMessageDialog(null, "Няма коли с този сериен номер "+ serNo);
        }
        else{
            carsArray=carAr;
            displayTable(carsArray);
...
//        dtm.setRowCount(0);
        ...
        if(counter==0)
        {   
            JOptionPane.showMessageDialog(null, "Няма кола с такъв модел "+modl);
        }
        else
        {
            carsArray=carAr;
...
//        dtm.setRowCount(0);
        ...
        if(counter==0)
        {   
            JOptionPane.showMessageDialog(null, "Няма коли в град "+cityy);
        }
        else
        {
            carsArray=carAr;
...
//        dtm.setRowCount(0);
        ...
        if(counter==0)
        {   
            JOptionPane.showMessageDialog(null, "Няма коли с минал преглед");
        }
        else
        {
            carsArray=carAr;
    ...
    private void initComponents() {
        ...
        updateBTN.setText("Актуализирай");
        ...
        modelNumberLBL.setText("Номер на модела");

        cityLBL.setText("Град");

        minSeatLBL.setText("Места за сядане мин");

        certificateExpiryLBL.setText("Прегледа изтича на ");

        maxSearLBL.setText("Места за сядане макс");

        serialNumberLBL.setText("Сериен номер");

        manufactureYearLBL.setText("Година на производство");

        manufacturerLBL.setText("Производител");

        availableRadio.setText("Наличен");
        ...
        unavailableRadio.setText("Зает");

        luTXT.setText("Последно актуализиран на:");

        lastUpdated.setText("     ");

        filterBTN.setText("Филтрирай");
