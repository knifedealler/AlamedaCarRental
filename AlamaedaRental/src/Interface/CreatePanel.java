...
public class CreatePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        addCarLbl.setText("Добави автомобил");

        createButton.setText("Добави автомобила");
        ...
        modelNumberLBL.setText("Номер на модел");
        ...
        certificateExpiryLBL.setText("Дата на изтичане на прегледа");

        minSeatLBL.setText("Мин места за сядане");

        maxSearLBL.setText("Макс места за сядане");
    ...
    private void createAction()
    {
        ...
        dateCheck(manufYr,"Произведен в година:");
        stringCheck(cIty, "Град");
        dateCheck(certExp, "Дата на изтичане на прегледа");
